...
<head>
    ...
    <title>BiT Payroll Management System &mdash; Bahir Dar Institute of Technology</title>
    ...
    <div class="hero-container">
        <div class="hero-content">
            ...
            <p class="hero-desc">
                ...
                digital payslip generation &mdash; all in one place.
            </p>
    ...
    <div class="section-container">
        ...
        <div class="steps-grid">
            ...
            <div class="step-card">
                ...
                <p>Finance officer runs monthly payroll &mdash; system auto-calculates tax and pension.</p>
            </div>
            <div class="step-arrow"><i class="fas fa-chevron-right"></i></div>
            <div class="step-card">
...
<footer class="site-footer">
    <div class="footer-container">
        <div class="footer-grid">
            ...
            <div class="footer-brand">
                ...
                <p class="footer-desc">
                    ...
                    for BiT staff &mdash; ensuring accurate, transparent, and timely salary processing.
                </p>
            </div>
        ...
        <div class="footer-bottom">
            <p>&copy; <?= date('Y') ?> Bahir Dar Institute of Technology &mdash; BiT Payroll Management System. All rights reserved.</p>
